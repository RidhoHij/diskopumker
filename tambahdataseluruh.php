...
<?php
  ...
  if(isset($_GET['update'])){
    $id_dataseluruh = $_GET['update'];
    
    $query ="SELECT * FROM dataseluruh WHERE id_dataseluruh = '$id_dataseluruh';";
...
<body>
  ...
  <br>
  <div class = "container">
    <form action="prosesdataseluruh.php" method="post" enctype="multipart/form-data">
      <input type= "hidden" value="<?php echo $id_dataseluruh; ?>" name="id_dataseluruh">
