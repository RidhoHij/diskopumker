...
<?php
  ...
  if(isset($_GET['update'])){
    $id_hubunganindustrial = $_GET['update'];
    
    $query ="SELECT * FROM hubunganindustrial WHERE id_hubunganindustrial = '$id_hubunganindustrial';";
...
<body>
  ...
  <h1>Data Hubungan Industrial</h1>
  <br>
  <div class = "container">
    <form action="proseshubunganindustrial.php" method="post" enctype="multipart/form-data">
      <input type= "hidden" value="<?php echo $id_hubunganindustrial; ?>" name="id_hubunganindustrial">
