...
<body>
    ...
    <h1> Data koperasi</h1>
      ...
      <div class="pull-right col-2">
        <a href ="tambahkoperasi.php"><i class="fa-solid fa-plus">tambah data</i></a>
      </div>

    <div class ="input-group">
      <label>Search :</label>
      <form action="datakoperasi.php" method="POST">
    ...
    <div class = "container">
      <table class="table table-striped" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
          ...
          <td>
              <a href="tambahkoperasi.php?update=<?php echo $result['id_datakoperasi']; ?>" type="botton" class="fa-sharp fa-solid fa-pen"></a>
              <a href="proseskop.php?hapus=<?php echo $result['id_datakoperasi']; ?>" type="botton" class="fa-solid fa-trash class="fa-solid fa-trash style="color: #ff0000;"></a>  
          </td>
        </tr>
        <?php
          }
      ...
      if($page>1){
        echo "<a href='datakoperasi.php?page=".($page-1)."' class = 'btn btn-danger'>Previous</a>";
      }

      for($i=1; $i<$total_page;$i++){

        echo "<a href='datakoperasi.php?page=".$i."' class = 'btn btn-primary'>$i</a>";
      }

      if($i>$page){
        echo "<a href='datakoperasi.php?page=".($page+1)."' class = 'btn btn-danger'>Next</a>";
      }
