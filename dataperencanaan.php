...
if (isset($_POST['cari'] )){
  ...
  $query = "SELECT * FROM perencanaan WHERE nama_data like '%" .$pencarian. "%'" ;
}else{
$page = (isset($_GET['page']))? (int)$_GET['page'] : 1;
$num_per_page = 5;
$start_from = ($page-1)*5;
$query = "SELECT *FROM perencanaan ORDER BY id_data DESC limit $start_from,$num_per_page";
}
...
<body>
    ...
    <h1> Data Umpeg</h1>
      ...
      <div class="pull-right col-2">
        <a href ="tambahperen.php"><i class="fa-solid fa-plus">tambah data</i></a>
      </div>

    <div class ="input-group">
      <label>Search :</label>
      <form action="dataperencanaan.php" method="POST">
    ...
    <div class = "container">
      <table class="table table-striped" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
          ...
          <td>
              <a href="tambahperen.php?update=<?php echo $result['id_data']; ?>" type="botton" class="fa-sharp fa-solid fa-pen"></a>
              <a href="proses.php?hapus=<?php echo $result['id_data']; ?>" type="botton" class="fa-solid fa-trash class="fa-solid fa-trash style="color: #ff0000;"></a>  
          </td>
        </tr>
        <?php
          }
      ...
      <?php
      $pr_query = "SELECT *FROM perencanaan";
      ...
      if($page>1){
        echo "<a href='dataperencanaan.php?page=".($page-1)."' class = 'btn btn-danger'>Previous</a>";
      }

      for($i=1; $i<$total_page;$i++){

        echo "<a href='dataperencanaan.php?page=".$i."' class = 'btn btn-primary'>$i</a>";
      }

      if($i>$page){
        echo "<a href='dataperencanaan.php?page=".($page+1)."' class = 'btn btn-danger'>Next</a>";
      }
