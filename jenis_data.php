...
<body>
    ...
    <h1> Jenis Data</h1>
      ...
      <div class="pull-right">
        <a href ="tambahjenis.php" class="btn success"><i class="fa-solid fa-plus">tambah jenis</i></a>
      </div><br>
      ...
      <table class="table table-striped" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
          ...
          <td><?php echo $result['jenis_data']; ?></td>
          <td>
              <a href="tambahjenis.php?update=<?php echo $result['id_jenis']; ?>" type="botton" class="fa-sharp fa-solid fa-pen"></a>
              <a href="prosesjenis.php?hapus=<?php echo $result['id_jenis']; ?>" type="botton" class="fa-solid fa-trash class="fa-solid fa-trash style="color: #ff0000;"></a>
          </td>
        </tr>
        <?php
          }
