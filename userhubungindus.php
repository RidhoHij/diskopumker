...
<body>
    ...
    <h1> Hubungan industrial</h1><br>
    <div class ="input-group">
      <label>Search :</label>
      <form action="userhubungindus.php" method="POST">
    ...
    <div class = "container">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            <button type = "button" class = "btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalViewData<?php echo $result['id_hubunganindustrial']?>">
            Detail Data
            </button>
          
<!-- Modal view -->
<div class="modal fade" id="ModalViewData<?php echo $result['id_hubunganindustrial']?>" tabindex="-1" aria-labelledby="ModalViewDataLabel" aria-hidden="true">
