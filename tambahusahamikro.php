...
<?php
  ...
  if(isset($_GET['update'])){
    ...
    $query ="SELECT * FROM usahamikro WHERE id_usahamikro = '$id_usahamikro';";
...
<body>
  ...
  <br>
  <div class = "container">
    <form action="prosesusahamikro.php" method="post" enctype="multipart/form-data">
      <input type= "hidden" value="<?php echo $id_usahamikro; ?>" name="id_usahamikro">
