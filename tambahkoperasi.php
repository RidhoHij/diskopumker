...
<?php
  ...
  if(isset($_GET['update'])){
    $id_datakoperasi = $_GET['update'];
    
    $query ="SELECT * FROM koperasi WHERE id_datakoperasi = '$id_datakoperasi';";
...
<body>
  ...
  <br>
  <div class = "container">
    <form action="proseskop.php" method="post" enctype="multipart/form-data">
      <input type= "hidden" value="<?php echo $id_datakoperasi; ?>" name="id_datakoperasi">
