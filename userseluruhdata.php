...
if (isset($_POST['cari'] )){
  $page = (isset($_GET['page']))? (int)$_GET['page'] : 50;
  $num_per_page = 2;
  $start_from = ($page-1)*2;
...
<body>
    ...
    <h1> Seluruh Data</h1><br>
    <div class ="input-group">
      <label>Search :</label>
      <form action="userseluruhdata.php" method="POST">
    ...
    <div class = "container">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            <button type = "button" class = "btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalViewData<?php echo $result['id_dataseluruh']?>">
              Detail Data
            </button>
          
<!-- Modal view -->
<div class="modal fade" id="ModalViewData<?php echo $result['id_dataseluruh']?>" tabindex="-1" aria-labelledby="ModalViewDataLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class = "row">
          ...
          <div class =" col-sm-8">
          : <?php echo $result['nama_data']; ?><br/><br>
          : <?php echo $result['tanggal_hari']; ?><br/><br>
          : <?php echo $result['id_jenis']; ?><br/><br>
          : <a href ="berkas/<?php echo $result['file'];?>">Lihat File</a><br/><br>
          </div>
      </div>
      </div>
