...
<?php
  ...
  if(isset($_GET['update'])){
    $id_datakeuangan = $_GET['update'];
    
    $query ="SELECT * FROM keuangan WHERE id_datakeuangan = '$id_datakeuangan';";
...
<body>
  ...
  <br>
  <div class = "container">
    <form action="prosesuang.php" method="post" enctype="multipart/form-data">
      <input type= "hidden" value="<?php echo $id_datakeuangan; ?>" name="id_datakeuangan">
