...
<body>
    ...
    <h1> Data Pembinaan Kerja</h1><br>
    <div class ="input-group">
      <label>Search :</label>
      <form action="userpembinaankerja.php" method="POST">
    ...
    <div class = "container">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            <button type = "button" class = "btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalViewData<?php echo $result['id_tenagakerja']?>">
            Detail Data
            </button>
          
<!-- Modal view -->
<div class="modal fade" id="ModalViewData<?php echo $result['id_tenagakerja']?>" tabindex="-1" aria-labelledby="ModalViewDataLabel" aria-hidden="true">
